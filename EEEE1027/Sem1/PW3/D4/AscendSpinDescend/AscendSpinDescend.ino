...
bool
  ...
  lineFollowing = false;  // Flag indicating whether or not it is correctly positioned at the 0cm start mark

const unsigned long TOP_WAIT_DURATION = 4000;  // Amount of time in milliseconds to wait at the top of the ramp
