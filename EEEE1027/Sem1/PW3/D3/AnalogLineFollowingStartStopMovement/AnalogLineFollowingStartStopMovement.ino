...
void loop() {
  ...
  // Simulate reaching the top of the ramp and waiting for 4 seconds
  reachedTop = true;
  topWaitEnd = true;
  ...
  if (startPhase == true && (distance - currDistTravelled) <= 80) {
    lineFollowingLogic(MAIN_SPD, leftSensor, rightSensor);
  }
  ...
  if (stopPhase == true && () > STOP_PHASE_DUR) {
    stopPhase = false;
    startPhase = true;
    currDistTravelled = distance;
  }
